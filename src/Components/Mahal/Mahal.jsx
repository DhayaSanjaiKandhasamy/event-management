      ...
      <article>
        ...
        <Link to={`/mahal/${mahalData.id}`}>
          <div className="mt-4 flex flex-col  ">
            <p
              className="h-10 text-lg truncate font-sans font-bold"
              style={{ width: "260px" }}
            >
              {mahalData.name}
            </p>
            ...
            <p className="my-1">
              <span className="text-base font-medium ">
                Price Per Day: ₹{mahalData.pricePerDay}
              </span>{" "}
              <span className=" text-sm line-through	mx-1.5">
                ₹{mahalData.oldPricePerDay}
              </span>{" "}
              <span className="text-green-500	 text-sm">{"20"}% off</span>
            </p>
            <p className="text-xs text-gray-500	mt-2">
              {"tomorrow"} <b>{"10:30 AM"}</b>
            </p>
          </div>
        </Link>
      </article>
